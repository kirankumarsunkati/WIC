...
class AppFourteen extends React.Component{
  render(){
    return (
      ...
      <Col xl={6}>
      <Card>
        <Card.Title className={""}>Now, let's look at which members need to be added to the family.</Card.Title>
        <Card.Subtitle className={"commonCardSubTitle"}>WIC benefits are for pregnent and postpartum mothers and children
